...
class BetGame extends React.Component {
  ...
  */
  ...
  testRequet=()=>{
    ...
    let url = 'https://omegacoding.com/qualification/getComplatedLevelsOfCourse.php'+query_string;
    fetch(url)
    .then((resp) => resp.json())
    .then((data)=> {
      console.log(data);
...
/* START-> helpers addEventListeners */
    ...
    if(d !==-1 ) {
            ...
            if(drown === true) {
                  ...
                  if(countRepeats === 1) {
                      ...
                      this.setImageSource(9); // true-letter gif
                  ...
                  if(countRepeats === 1) {
                    ...
                    this.setImageSource(10); // false-letter gif
            ...
            if(str_guess === answer) {
                ...
                let betArray = this.state.betArray; // console.log(betArray);
                  ...
                  if(betArray[quest_id] !== undefined) {
                      // Next Question
                      console.log(' --- bgbgbgbg kkokogt  ');
                      this.setImageSource(7); // true-word
                      setTimeout(this.nextQuestion ,3600);
                      this.refs.smallFireChild.startFire();
                      setTimeout(this.refs.smallFireChild.stopFire,2550);

                  // for testing end-gameEnd
                  //setTimeout(this.gameEnd, 1000); // remove this

                  } else {
                      // End of Game
                      console.log('general-logic-i verj');
                      setTimeout(this.gameEnd, 2000);
  ...
  handleClick=(event)=> {
    if(event.target.hasAttribute('name')) {
        ...
        let keyboard = document.getElementsByClassName('keyboard-wrap-component')[0];
  ...
  componentDidMount() {
    ...
    function vh_sceneLoaded() {
      console.log('model is load successfuly - Armen');
    }
  }
  ...
  screenZeroStyle=()=> {
      ...
      this.enableAllBtns();
      this.setImageSource(8); // default state
  ...
  nextQuestion=()=> {
    console.log('ashxatacnuma');
  	if (component_was_unmounted !== true && this.state.multi !== true ) {
      this.stopTimer();
      ...
      //console.log('next-before  888888 ===>', this.state.betArray[this.state.quest_id].question);
      if(this.state.betArray[this.state.quest_id].question !== undefined) {
          ...
          console.log('next-before-check-undefined 999999999999999999==========', this.state.betArray);
          ...
          this.gameOverContext();
           ----| play again |--------*/
           console.log('next-question-i-verj');
           setTimeout(this.gameEnd, 1);
 ...
 showOverallPoints=()=> {
  ...
  render() {
    ...
    // <img src={image0} alt="image1" className="bet-robot-image"/>
      ...
      let multiplay = this.state.multi;

      // change language, and say by props to change keyboard language
      // rest of code see on the <Keyboard /> component.
      ...
      // console.log('lang-from-settings-props --- ', this.props.lang);
    ...
    return(
      ...
      />
          ...
          { ( !robImages || !betArray ) ? <span>Loading .......</span> :
          <div className="betArray-and-robImages-are-loaded">

          	{
          		showDemo?
          		<BetDemo unique_id={this.props.userProfile.uid} takeGameData = {betArray} closeShowDemoState = {this.changeShowDemo} />
          		:<div className="show-demo-is-false">
          			{
									multiplay?
										<div className="miasin">
											<Socketclient
                      ...
                      playSingle = {this.playSingle}
                      />
										</div>
									:
									<div className="men-menak">
	                    ...
	                    <div className="single-window" style={gameBackStyle}>
	                      ...
	                      <div className="bet-user-space">
	                          <div className="bet-this-user">
	                              ...
	                              <span className="bet-user-name" style={{display:'none'}}> answer -> {this.state.answer}</span><br/>
	                              ...
	                              <div className="bet-scores">
	                                  ...
	                                  <span className="bet-coins-count">
	                                    ...
	                                    <span className="bet-score-a-span">{this.state.scores} <span className="grow-step"></span> </span>
	                                        <span className="divider"> / </span>
	                                    <span className="bet-time-a-span">time bonuses +{this.state.timeBonus}</span>
	                                   </span>
	                              </div>
	                          </div>

	                          <div className="bet-round-and-timer-and-helpers">
	                              <div className="bet-roud" style={{visibility:'hidden'}}>Rounds:</div>
	                              <div className="bet-timer" onClick={this.testRequet}>
	                                <MyClock
	                      ...
	                      <div className="game-foot">
	                          <div className="bet-more-btn-wrap">
	                            <button onClick={this.toggleSpecials} className="bet-special-simbols" >{ specBtnText }</button><br/>
	                            <button onClick={this.goToLevelList} className="bet-exit-game" >{trans.buttons.exit}</button><br/>

                              <span style={showLngBtn}>
                                <button onClick={ this.toggleLanguage} className="bet-exit-game bet-toggle-lang">{ lngBtnText }</button><br/>
                              </span>
